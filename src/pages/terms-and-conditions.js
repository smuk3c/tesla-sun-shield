...
const TermsAndConditionsPage = () => (
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-[100px]">
    <div className="mx-auto max-w-3xl">
      ...
      <p className="mt-8">In no event shall SUNSHIELD d.o.o., its directors, employees, or affiliates be liable for any direct, indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or goodwill, arising out of or in connection with your access to or use of our Website, products, or services, even if we have been advised of the possibility of such damages. Your sole remedy for dissatisfaction with our Website, products, or services is to stop using them.</p>
      
      <h2 className="text-xl mt-8">Indemnification</h2>
      <p className="mt-8">You agree to defend, indemnify, and hold harmless SUNSHIELD d.o.o., its directors, employees, and affiliates from and against any and all claims, damages, costs, and expenses, including reasonable attorneys' fees, arising from or related to your use of the Website, products, or services, or your violation of these Terms.</p>
